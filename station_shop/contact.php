...
<title>Station Shop|Contact Page</title>
    ...
    <div id="templatemo_main">
   		<div id="sidebar" class="float_l">
        	<div class="sidebar_box"><span class="bottom"></span>
            	<h3>Categories<a href="http://fr.onlyimage.com" title="Seulement Image" class="more_link"  target="_blank"></a></h3>   
                <div class="content"> 
            ...
            <div class="sidebar_box"><span class="bottom"></span>
            	<h3>Best Sellers <a href="http://www.onlyimage.com/free-images/female" title="Female" class="more_link"  target="_blank"></a></h3>   
                <div class="content"> 
                	<div class="bs_box">
        ...
        <div id="content" class="float_r">
            ...
            <div class="content_half float_l">
                ...
                <div id="contact_form">
                   <form method="post" name="contact" action="process/contact.php" enctype="multipart/form-data">
