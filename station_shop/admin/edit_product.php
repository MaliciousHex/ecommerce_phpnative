		  ...
		  <div class="clear"></div>
            ...
            <div class="full_w" id="form_geje">
              ...
              <div>
                    ...
                    <input type="hidden" name="product_id" value="<?php echo $rownews['product_id']; ?>" />
                    
					<div class="element" >
						<label for="product_name"> Product Name <span class="red">(required)</span></label>
						<input id="title" name="product_name" class="text" 
                        value="<?php echo $rownews['product_name']; ?>" />
					</div>
                    
                    <div class="element">  
                    	
                        <label for="product_description">Product Description <span class="red">(required)</span></label>
						<textarea class="textarea" name="product_description" rows="10" ><?php echo $rownews['product_description']; ?></textarea>
                    ...
                    <div class="element"> 
                        ...
                        <input type="hidden" name="image_old" value="../images/product/ <?php echo $rownews['gambar']; ?>" />
