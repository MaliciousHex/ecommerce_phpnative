...
<title>Station Shop - Product Detail Page</title>
    ...
    <div id="templatemo_main">
   		<div id="sidebar" class="float_l">
        	<div class="sidebar_box"><span class="bottom"></span>
            	<h3>Categories<a href="http://www.onlyimage.com" title="click from www.onlyimage.com" class="more_link"  target="_blank"></a></h3>   
                <div class="content"> 
            ...
            <div class="sidebar_box"><span class="bottom"></span>
            	<h3>Best Sellers <a href="http://it.onlyimage.com/free-images/yellow" title="giallo Immagine" class="more_link"  target="_blank"></a></h3>   
                <div class="content"> 
                	<div class="bs_box">
        ...
        <div id="content" class="float_r">
        	...
        	<a  rel="lightbox[portfolio]" href="images/product/<?php echo $rowproduct['gambar']; ?>"><img src="images/product/<?php echo $rowproduct['gambar']; ?>" alt="Image <?php echo $rowproduct['product_id']; ?>" /></a>
            </div>
            <div class="content_half float_r">
				<table>
                    ...
                    <tr>
                        ...
                        <td><?php echo $rowproduct['brand']; ?></td>
                    </tr>
                    <tr><td height="30">Stock</td><td><?php echo $rowproduct['stock']; ?></td></tr>
                </table>
            ...
            <p>Disini Product Description.</p>	
